...
>(({ className, children }, ref) => {
  return (
    ...
    <div ref={ref} className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] m-0",
        className,)}
        >
            {children}
            </div>
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-screen w-screen items-center justify-center overflow-hidden p-screen"
      ref={containerRef}
    >
